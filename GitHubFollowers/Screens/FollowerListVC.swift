...
class FollowerListVC: UIViewController {
    ...
    private func configureCollecionView() {
        collectinView = UICollectionView(frame: view.bounds, collectionViewLayout: UIHelper.createThreeColumnFlowLayout(in: view))
        view.addSubview(collectinView)
        collectinView.delegate = self
        collectinView.backgroundColor = .systemBackground
        collectinView.register(FollowerCell.self, forCellWithReuseIdentifier: FollowerCell.reuseID)
    }
